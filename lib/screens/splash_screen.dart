...
class _SplashScreenState extends State<SplashScreen>
  ...
  List<Widget> _buildFloatingDots(Size size) {
    final dots = <_DotData>[
      _DotData(0.08, 0.12, 16, CyberTheme.limeGreen.withValues(alpha: 0.4), 0),
      _DotData(0.88, 0.08, 24, CyberTheme.hotPink.withValues(alpha: 0.3), 0.3),
      _DotData(0.92, 0.35, 12, CyberTheme.electricBlue.withValues(alpha: 0.35), 0.6),
      _DotData(0.05, 0.55, 20, CyberTheme.sunOrange.withValues(alpha: 0.3), 0.1),
      _DotData(0.75, 0.75, 14, CyberTheme.limeGreen.withValues(alpha: 0.35), 0.7),
      _DotData(0.2, 0.88, 18, CyberTheme.hotPink.withValues(alpha: 0.25), 0.4),
      _DotData(0.5, 0.05, 10, CyberTheme.electricBlue.withValues(alpha: 0.4), 0.8),
      _DotData(0.65, 0.15, 8, CyberTheme.goldenYellow.withValues(alpha: 0.5), 0.5),
    ];
          ...
          return Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                  color: CyberTheme.outlineBlack.withValues(alpha: 0.2),
                  width: 1.5,
                ),
              ),
            ),
